      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Text('0'+(_currentIndex+1).toString()+'.', style: TextStyle(
              fontSize: width*0.05,
            ...
            child: Center(
              child: ButtonTheme(
                ...
                child: ElevatedButton(
                  child: _currentIndex == widget.quizs.length -1 ? Text('결과보기') : Text('다음문제보기'),
                  // textColor: Colors.white,
                  // color: Colors.deepPurple,
                  onPressed: _answers[_currentIndex] == -1 ? null : (){
                    if (_currentIndex == widget.quizs.length -1){
                      Navigator.push(
                          context, MaterialPageRoute(builder: (context) => ResultScreen(answers: _answers, quizs: widget.quizs))
                      );
                    }else{
